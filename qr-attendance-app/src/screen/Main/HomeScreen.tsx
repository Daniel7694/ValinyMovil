...
const HomeScreen = () => {
  ...
  const handleSearch = async () => {
    try {
      ...
      const updateResponse = await fetch(`http://192.168.181.244:3000/api/estudiantes/${id}`, options);
    ...
    try {
      const response = await fetch(`http://192.168.181.244:3000/api/estudiantes/${id}`);
